# Portfólio — HTML, CSS e JavaScript (Site Estático)
...
- **Tema escuro** (dark) com contraste confortável
- **Responsivo** (mobile-first) — menu colapsa em telas menores
- Interações leves com **JavaScript** (ex.: abrir/fechar menu, cards, modais, carrossel — se houver)
- **Sem build**: apenas arquivos estáticos (funciona em qualquer hosting)
